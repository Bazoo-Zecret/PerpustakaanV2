...
<div class="form-group">
    ...
    <input type="text" name="nis" placeholder="Masukkan NISN" class="form-control" value="<?= $u->nis; ?>">
</div>
<div class="form-group">
    <label for="">Nama Siswa</label>
    <input type="text" name="nama" placeholder="Masukkan Nama" class="form-control" value="<?= $u->nama; ?>">
</div>
<div class="form-group">
